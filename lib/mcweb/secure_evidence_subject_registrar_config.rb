...
module Mcweb
  module SecureEvidenceSubjectRegistrarConfig
    KEY = :secure_evidence_subject_registrars
    CONTAINER_ERROR = "secure_evidence_subject_registrars_must_be_array"
    CONFIG_ERROR = "secure_evidence_subject_config_invalid"
    STORE_ERROR = "secure_evidence_subject_config_store_invalid"
    REGISTRAR_ERROR = "secure_evidence_subject_registrar_must_be_callable"
    DUPLICATE_ERROR = "secure_evidence_subject_registrar_duplicate"
    FROZEN_ERROR = "secure_evidence_subject_registrars_frozen"
    ...
    def register!(custom_config, registrar)
      initialize!(custom_config) unless configuration_store!(custom_config).key?(KEY)
