...
test('account center is a state dashboard built from the shared Arco UI library', () => {
  ...
  assert.match(page, /routes\.forumNew/)
  assert.match(page, /routes\.forumUnread/)
  assert.match(page, /routes\.forumWatching/)
  assert.match(page, /routes\.forumFollowing/)
  assert.match(page, /routes\.forumWatchedTags/)
  assert.match(page, /routes\.forumBookmarks/)
  assert.match(page, /routes\.forumBlocks/)
  assert.match(page, /routes\.forumIgnores/)
  assert.match(page, /routes\.forumMuted/)
  assert.match(page, /routes\.sessionsManagement/)
  assert.match(page, /routes\.identityDataExports/)
  assert.match(page, /lg: minecraft_enabled \? 3 : 2/)
