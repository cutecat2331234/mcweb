...
module Mcweb
  module IdentityAccountClosureRegistrarConfig
    KEY = :identity_account_closure_registrars
    CONTAINER_ERROR = "identity_account_closure_registrars_must_be_array"
    CONFIG_ERROR = "identity_account_closure_config_invalid"
    STORE_ERROR = "identity_account_closure_config_store_invalid"
    REGISTRAR_ERROR = "identity_account_closure_registrar_must_be_callable"
    DUPLICATE_ERROR = "identity_account_closure_registrar_duplicate"
    FROZEN_ERROR = "identity_account_closure_registrars_frozen"
