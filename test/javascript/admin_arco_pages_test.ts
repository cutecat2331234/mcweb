...
test('system settings use an Arco form while retaining the nested settings mutation', () => {
  ...
  assert.match(source, /<a-tabs/)
  assert.match(source, /type="rounded"/)
  assert.match(source, /hide-content/)
  ...
  assert.match(source, /setting\.control === 'number'/)
  assert.match(source, /<a-input-number/)
  assert.match(source, /setting\.control === 'textarea'/)
  assert.match(source, /<a-textarea/)
  assert.match(source, /setting\.control === 'password'/)
  assert.match(source, /<a-input-password/)
  assert.match(source, /setting\.control === 'readonly'/)
  assert.match(source, /<a-input/)
  assert.match(source, /<a-button/)
