...
module Mcweb
  module OperationsManualTaskRegistrarConfig
    KEY = :operations_manual_task_registrars
    CONTAINER_ERROR = "operations_manual_task_registrars_must_be_array"
    CONFIG_ERROR = "operations_manual_task_config_invalid"
    STORE_ERROR = "operations_manual_task_config_store_invalid"
    REGISTRAR_ERROR = "operations_manual_task_registrar_must_be_callable"
    DUPLICATE_ERROR = "operations_manual_task_registrar_duplicate"
    FROZEN_ERROR = "operations_manual_task_registrars_frozen"
    ...
    def configuration_store!(custom_config)
      # Rails 8 config.x is a Custom object whose dotted reads auto-create an
      # OrderedOptions value. Read its backing store so absence and corruption
      # remain distinguishable instead of becoming a truthy empty object.
