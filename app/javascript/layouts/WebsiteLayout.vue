...
<template>
  <div class="website-page">
    <header class="website-nav sticky top-0 z-50">
      <div class="mx-auto flex max-w-6xl items-center justify-between px-4 py-3.5">
        <Link :href="routes.home" class="website-brand">
          <span class="website-brand-mark">⛏</span>
          <span class="text-lg font-semibold tracking-tight">McWeb</span>
        </Link>
    ...
    <footer class="website-footer py-12">
      <div class="mx-auto max-w-6xl px-4">
        ...
        <p class="mt-10 border-t border-white/10 pt-6 text-center text-xs text-slate-500">
          © {{ new Date().getFullYear() }} McWeb · 用户功能位于 /app 模块
        </p>
      </div>
    </footer>
  </div>
