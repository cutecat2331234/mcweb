...
module Mcweb
  module IdentityDataExportRegistrarConfig
    KEY = :identity_data_export_registrars
    CONTAINER_ERROR = "identity_data_export_registrars_must_be_array"
    CONFIG_ERROR = "identity_data_export_config_invalid"
    STORE_ERROR = "identity_data_export_config_store_invalid"
    REGISTRAR_ERROR = "identity_data_export_registrar_must_be_callable"
    DUPLICATE_ERROR = "identity_data_export_registrar_duplicate"
    FROZEN_ERROR = "identity_data_export_registrars_frozen"
