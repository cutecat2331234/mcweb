...
class AddForumAttachmentSecurityManagePermission < ActiveRecord::Migration[8.1]
  PERMISSION_KEY = "forum.attachments.security.manage"
  ...
  def up
    execute <<~SQL.squish
      ...
      VALUES (
        ...
        'forum',
        'Retry attachment scans and cleanup, prune orphaned uploads, and remove attachments',
        CURRENT_TIMESTAMP,
        CURRENT_TIMESTAMP
      )
