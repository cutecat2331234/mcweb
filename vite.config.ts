...
export default defineConfig({
  ...
  build: {
    ...
    rolldownOptions: {
      output: {
        codeSplitting: {
          groups: arcoChunkGroups.map((group) => ({
            name: group.name,
            test: (id) => isArcoRuntimeGroup(id, group),
