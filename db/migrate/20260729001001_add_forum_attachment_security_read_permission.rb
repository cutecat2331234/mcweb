...
class AddForumAttachmentSecurityReadPermission < ActiveRecord::Migration[8.1]
  PERMISSION_KEY = "forum.attachments.security.read"
  ...
  def up
    execute <<~SQL.squish
      ...
      VALUES (
        ...
        'View attachment security',
        'forum',
        'View attachment scanning, quarantine, quota, and cleanup status',
        CURRENT_TIMESTAMP,
        CURRENT_TIMESTAMP
      )
