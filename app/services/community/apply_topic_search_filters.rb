...
module Community
  class ApplyTopicSearchFilters < ApplicationService
    def initialize(scope:, solved_filter: nil, locked_filter: nil, pinned_filter: nil, wiki_filter: nil, featured_filter: nil, announcement_filter: nil, unlisted_filter: nil, poll_filter: nil, noreplies_filter: nil)
      @scope = scope
