...
module ServiceErrorTranslator
  EXACT = {
    ...
    "Invalid permission keys." => "mcweb.services.errors.invalid_permission_keys",
    "Unknown group operation." => "mcweb.services.errors.unknown_group_operation",
    "User group or member not found." => "mcweb.services.errors.user_group_or_member_not_found",
    "Unknown role operation." => "mcweb.services.errors.unknown_role_operation",
    "Role not found." => "mcweb.services.errors.role_not_found",
    "Invalid permission ids." => "mcweb.services.errors.invalid_permission_ids",
    "System roles cannot be changed." => "mcweb.services.errors.system_role_immutable",
    "System roles cannot be deleted." => "mcweb.services.errors.system_role_immutable",
    "A replacement role is required before retiring an assigned role." => "mcweb.services.errors.replacement_role_required",
    "A role cannot replace itself." => "mcweb.services.errors.replacement_role_same",
    "Replacement role not found." => "mcweb.services.errors.replacement_role_not_found",
